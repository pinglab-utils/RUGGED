...
class TestAgents(unittest.TestCase):
    ...
    # TODO a separate class for llm tests, for ollama, kobold, huggingface, and openai
    ...
    def test_reasoning_agent(self):
        ...
        # TODO change this to something like "Does this support the claim that _"
    ...
    def test_text_evaluator_agent(self):
        ...
        #TODO change this to something easy like "Is this passage relevant to cardiovascular disease?" and provide Lorem ipsem
    ...
    def test_cypher_query_agent(self):
        ...
        #TODO change this to something easy like "Write a cypher query to see how many nodes are in the graph."
    ...
    def test_query_verification_agent(self):
        ...
        #TODO change this to something obvious like a syntax error or "Given this cypher query, figure out what's wrong or fix it" and it's a namespace violation
